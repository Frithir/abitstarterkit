...
function my_custom_logo() {
  ...
  #wpadminbar #wp-admin-bar-wp-logo > .ab-item .ab-icon:before {
    background-image: url("https://thriveweb.com.au/email6/mini-sig.gif") !important;
...
function custom_admin_footer() {
  echo 'By <a href="https://thriveweb.com.au/" title="Visit thriveweb.com.au for more information">thriveweb.com.au</a>';
...
function my_login_logo() { ?>
  ...
  #login h1 a, .login h1 a {
    background-image: url(<?php echo bloginfo( 'stylesheet_directory' ) ?>/images/logo.svg) !important;
    margin: 0 auto;
    height: 150px;
    width: 80%;
